...
class Hero(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.cur_right = 0
        self.cur_left = 0
        self.image = pygame.transform.scale(load("r_1", -1), (20, 38))
    ...
    def update(self, add_x, add_y, *groups):
        ...
        if self.count == 3:
            ...
            if add_x == 0 and add_y == 0:
                x = self.rect.x
                y = self.rect.y
                self.image = pygame.transform.scale(self.right[0], (20, 38))
                self.rect = self.image.get_rect()
                self.rect.x = x
                self.rect.y = y
            if add_x > 0 or add_y > 0:
                x = self.rect.x
                y = self.rect.y
                self.image = pygame.transform.scale(self.right[self.cur_right], (20, 38))
            ...
            if add_y < 0 or add_x < 0:
                x = self.rect.x
                y = self.rect.y
                self.image = pygame.transform.scale(self.left[self.cur_left], (20, 38))
